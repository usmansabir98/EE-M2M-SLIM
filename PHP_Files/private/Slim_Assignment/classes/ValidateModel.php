 ...
 class ValidateModel
 {
    ...
    */
	 ...
	 public function validate_feature($p_type_to_check)
	 {
		 ...
		 $m_arr_calculation_type = array('login', 'register', 'download_ee_form', 'review_ee_form', 'send_ee_message', 'circuit_board', 'review_logs');    //feature checked against this array
